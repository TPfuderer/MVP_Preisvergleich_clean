...
CSV_IMG_DIR_ALDI = DATA_DIR / "images" / "images_aldi"
ALL_CSV_IMG_DIRS = [CSV_IMG_DIR, CSV_IMG_DIR_ALDI, CSV_IMG_DIR_MARKTGURU, CSV_IMG_DIR_REWE, CSV_IMG_DIR_TEGUT,CSV_IMG_DIR_KAUFLAND, CSV_IMG_DIR_NETTO]
